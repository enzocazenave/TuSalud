  ...
  return (
    <View className="pt-9 px-5 gap-4">
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Text className="text-center text-lg text-primary dark:text-secondary">
...
const NotificationItem = ({
  ...
  return (
    <Swipeable
      ...
      <View className="border-b border-primary dark:border-gray-700 py-4 gap-1">
        <Text className={`text-lg text-primary dark:text-secondary`}>
          {notification.message}
        </Text>
        <Text className="text-sm text-primary dark:text-secondary">
          {formattedDate}
        </Text>
      </View>
    </Swipeable>
