  ...
  return (
    <View className="flex-col gap-4">
      {prepaidAffiliation?.prepaid?.name && (
        <View className="bg-secondary/30 rounded-lg px-4 py-3 flex flex-row items-center gap-4">
          <View className="bg-primary rounded-full p-1">
            <Check size={18} color="#fff" />
          </View>
          <View>
            <Text className="text-primary text-lg">1. Obra Social</Text>
      ...
      {specialty?.name && (
        <View className="bg-secondary/30 rounded-lg px-4 py-3 flex flex-row items-center gap-4">
          ...
          <View>
            <Text className="text-primary text-lg">2. Especialidad</Text>
            <Text className="text-primary font-bold text-xl">
              {specialty?.name}
            </Text>
          </View>
      ...
      {professional?.full_name && (
        <View className="bg-secondary/30 rounded-lg px-4 py-3 flex flex-row items-center gap-4">
          ...
          <View>
            <Text className="text-primary text-lg">3. Profesional</Text>
            <Text className="text-primary font-bold text-xl">
              {professional?.full_name}
            </Text>
          </View>
...

      {
        slot?.start_time && (
          <View className="bg-secondary/30 rounded-lg px-4 py-3 flex flex-row items-center gap-4">
            ...
            <View>
              <Text className="text-primary text-lg">4. Fecha y Horario</Text>
              
              <View className="flex-row items-center gap-2">
                <Calendar size={16} color="#006A71" />
                <Text className="text-primary font-bold text-xl">
